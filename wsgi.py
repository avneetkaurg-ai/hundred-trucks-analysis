...
NEON_URL = os.environ.get('DATABASE_URL', 'postgresql://neondb_owner:npg_aYBsA6cw8zMH@ep-sweet-river-aoofzrdu.c-2.ap-southeast-1.aws.neon.tech/neondb?sslmode=require')
