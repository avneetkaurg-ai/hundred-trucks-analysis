...
try:
    ...
    scheduler.add_job(ping_credit,        'cron', hour=9,  minute=0)            # 9:00 AM IST (Zoho sync + FASTag ping)
    ...
    scheduler.add_job(sync_credit_trips,  'cron', hour=9,  minute=0)            # 9:00 AM IST
    ...
    scheduler.add_job(sync_enroute_trips, 'cron', hour=11, minute=0)            # 11:00 AM IST
    scheduler.add_job(sync_enroute_trips, 'cron', hour=19, minute=0)            # 7:00 PM IST
