...
GMAIL_PASS   = os.environ.get('GMAIL_PASS', 'oxst pgte uyjc avuk')
REPORT_TO    = os.environ.get('REPORT_TO', 'avneetkaur.g@mirchi-lime.com')
    ...
    try:
        ...
        <div style="font-family:Arial,sans-serif;max-width:700px;margin:auto;">
          <div style="background:#1a1a2e;padding:20px;border-radius:8px 8px 0 0;">
            ...
            <p style="color:#aaa;margin:4px 0 0;">{today} &nbsp;·&nbsp; {len(trucks)} trucks enroute</p>
          </div>
        ...
        msg['Subject'] = f'Daily Truck Report — {today}'
        msg['From']    = GMAIL_USER
        msg['To']      = REPORT_TO
